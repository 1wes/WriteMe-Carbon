...
export const validateStep1 = (formData: any) => {
  ...
  if (
    ...
    return {
      isValid: false,
      message:
        "Please fill in all fields as they are required before proceeding to the next step.",
    };
  }
...
export const validateStep2 = (formData: any) => {
  ...
  if (service !== "Writing" && files.length == 0) {
    return {
      isValid: false,
      message:
        "Any other service other than writing requires files to be attached before proceeding to the next step.",
    };
  }
...
export const validateStep3 = (formData: any) => {
  ...
  if (deadline === "" || time === "") {
    return {
      isValid: false,
      message:
        "Please fill in deadline date and time before proceeding to the next step",
    };
  }
