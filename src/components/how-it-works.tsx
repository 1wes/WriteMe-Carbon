...
const StepsCard: FunctionComponent<{
  stepIcon: ReactNode;
  stepName: string;
  details: string;
}> = ({ stepIcon, stepName, details }) => {
  return (
    <>
      <div className="steps-card">
        ...
        <h3 className="step-name">{stepName}</h3>
      ...
      <section className="section" id="how-it-works-section">
        <div className="how-it-works">
          <SectionHeader
            ...
            tagline={`Want to post your order? Learn the steps to enable you to do that in less than two minutes.`}
          />

          <div className="steps">
            <StepsCard
              stepIcon={<MdAssignmentAdd />}
              stepName={`1. Submit Your Assignment.`}
              details={`Fill in the provided form with authentic personal information and assignment details and choose your deadline`}
            />
            <StepsCard
              stepIcon={<MdOutlinePayment />}
              stepName={`2. Get A Quote and Pay.`}
              details={`We will send you a quote in your work within 2 minutes. Pay using supported methods to process your order.`}
            />
            <StepsCard
              stepIcon={<BsFileEarmarkCheck />}
              stepName={`3. Receive Solution`}
            ...
            />
            <StepsCard
              stepIcon={<VscFeedback />}
              stepName={`4. Provide Feedback`}
